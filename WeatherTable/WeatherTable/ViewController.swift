...
//  WeatherTable
//
//  Created by Kihyun Choi on 2018. 7. 25..
...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let dict3 = ["지역":"미국", "날씨":"눈"]
        let dict4 = ["지역":"러시아", "날씨":"우박"]
        let dict5 = ["지역":"태국", "날씨":"흐림"]
        let dict6 = ["지역":"프랑스", "날씨":"비"]
        let dict7 = ["지역":"영국", "날씨":"맑음"]
        let dict8 = ["지역":"캐나다", "날씨":"눈"]
        let dict9 = ["지역":"호주", "날씨":"우박"]
        let dict10 = ["지역":"중국", "날씨":"흐림"]
        let dict11 = ["지역":"덴마크", "날씨":"비"]
        let dict12 = ["지역":"스위스", "날씨":"맑음"]
        let dict13 = ["지역":"네덜란드", "날씨":"눈"]
        let dict14 = ["지역":"스페인", "날씨":"우박"]
        let dict15 = ["지역":"크로아티아", "날씨":"흐림"]
        let dict16 = ["지역":"아르헨티나", "날씨":"비"]
        let dict17 = ["지역":"이탈리아", "날씨":"맑음"]
        let dict18 = ["지역":"벨기에", "날씨":"눈"]
        let dict19 = ["지역":"폴란드", "날씨":"우박"]
        let dict20 = ["지역":"체코", "날씨":"흐림"]
